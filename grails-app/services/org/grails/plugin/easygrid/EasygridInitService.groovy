...
import static grails.util.GrailsClassUtils.getStaticFieldValue
...
class EasygridInitService {
    ...
    def initializeGrids() {
        ...
        grailsApplication.controllerClasses?.findAll { it.clazz.isAnnotationPresent(Easygrid) }?.each { controller ->
            log.trace "Initializing grids for controller....${controller}"
...
*/
    ...
    def Map<String, GridConfig> initControllerGrids(GrailsControllerClass controller, controllerBean = null) {
        ...
        log.trace "controller grids map....${controllerGridsMap}"
    ...
    def GridConfig addDefaultValues(GridConfig originalGridConfig) {
        ...
        log.trace "looking for default easygrid configs in application config....${grailsApplication.config.easygrid}"
        ...
        log.trace "default values.....${defaultValues}"
